...
cat ${FILEROOT}.myc > tmp_${FILEROOT}_1.txt
...
python3 linker.py tmp_${FILEROOT}_3.txt > tmp_${FILEROOT}_4.txt
python3 assembler.py tmp_${FILEROOT}_4.txt > tmp_${FILEROOT}_5.txt
